...
void loop(void) {
  ...
  if (event.acceleration.x > 2.0 & event.acceleration.y > 2.0){
    peny += 1;
    penx += 1;
    tft.drawPixel(penx, peny, HX8357_RED);
  } 
  else if (event.acceleration.x > 2.0 & event.acceleration.y < -2.0){
    peny += 1;
    penx -= 1;
    tft.drawPixel(penx, peny, HX8357_RED);
  }
  ...
  else if (event.acceleration.x > 2.0){
    peny += 1;
    tft.drawPixel(penx, peny, HX8357_RED);
  }
  else if (event.acceleration.x < -2.0){
  ...
  else if (event.acceleration.y > 2.0){
    penx += 1;
    tft.drawPixel(penx, peny, HX8357_RED);
  }
  else if (event.acceleration.y < -2.0){
